...
const Home = () => {
  return (
    <section
      className="m-0 p-0 w-full bg-no-repeat bg-cover h-screen"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="flex flex-col items-end mt-5 my-auto">
        ...
        <div className="w-11/12 mx-auto md:mr-5 md:w-6/12 lg:w-4/12  bg-white p-4 rounded-lg border border-coolGray-200 shadow-md">
          <Login title="Student" />
        </div>
      </div>
    </section>
